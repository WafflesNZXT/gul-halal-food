          ...
          <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
            ...
            <Reveal className="w-full lg:w-1/2 flex justify-center">
              <div className="w-full max-w-lg">
                <img
                  src={logoImg}
                  alt="Full Gul Halal Food official logo"
                  className="w-full h-auto object-contain drop-shadow-md"
                />
                <p className="mt-5 text-center font-display text-xl text-primary/70">
                  A legacy of flavor and family
                </p>
              </div>
            </Reveal>

            <Reveal className="w-full lg:w-1/2 space-y-6 text-foreground/80 text-lg leading-relaxed" delay={0.1}>
              <h2 className="text-3xl md:text-5xl font-display text-primary mb-6">
                Family Recipes, Shared with Love
              </h2>
              <p>
                Since {config.established}, {config.businessName} has shared Pakistani halal food
                for gatherings and celebrations.
              </p>
              <p>
                We believe that food is more than just sustenance—it's a way to show care,
                hospitality, and love. Every dish we prepare is rooted in Pakistani culinary tradition.
              </p>
              <p>
