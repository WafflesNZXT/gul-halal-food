...
const presentations: Record<OrderStatus, StatusPresentation> = {
  ...
  preparing: { label: "Preparing", badgeClass: "border border-rose-300 bg-rose-100 text-rose-900", markerClass: "bg-rose-700 text-white", textClass: "text-rose-900", selectionClass: "border-rose-600 bg-rose-100 text-rose-950" },
